...
$(document).on('click', '.btn-consultar-categoria', function () {
...
$(document).on('click', '.btn-editar-categoria', function () {
    const id = $(this).data('id'); // Obtener el ID de la categoría
    const url = $(this).data('url'); // Obtener la URL del archivo
...
$(document).on('click', '.btn-eliminar-categoria', function () {
    ...
    $('#modalContent').html(`
        <div class="text-center">
            ...
            <p>Esta acción eliminará permanentemente la categoría con ID: <strong>${id}</strong>.</p>
        </div>
...
$(document).on('click', '.btn-confirmar-eliminar-categoria', function () {
    ...
    $.post(url, { id: id }, function (data) {
        $('#modalContent').html('<p>Categoría eliminada correctamente.</p>');
        ...
        $('#modalContent').html('<p>Error al intentar eliminar la categoría.</p>');
    });
});